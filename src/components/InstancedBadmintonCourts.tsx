/**
 * InstancedBadmintonCourts Component
 *
 * High-performance badminton court renderer using THREE.js InstancedMesh.
 * Reduces 80 draw calls (16 courts × 5 meshes) to ~4 draw calls.
 */
...
interface InstancedBadmintonCourtsProps {
    courts: CourtConfig[];
}
...
const courtMaterial = new THREE.MeshStandardMaterial({ color: '#059669' });
...
const InstancedBadmintonCourts: React.FC<InstancedBadmintonCourtsProps> = ({ courts }) => {
...
export default InstancedBadmintonCourts;
