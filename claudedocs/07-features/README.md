...
**Directory**: `claudedocs/07-features/`
...
- **Implementation**: `/claudedocs/02-implementation-guides/` - Development guidelines
- **Testing**: `/claudedocs/03-testing-quality/` - Feature validation
- **Workflows**: `/claudedocs/05-workflows/` - Feature development process
- **Research**: `/claudedocs/06-research/` - Technology exploration
