...
## Related Research & Feature Documentation

### Controlled Environment Agriculture (CEA) - L3 Floor
- **Documentation**: [CEA_IMPROVEMENT_PLAN.md](../05-features/cea-facility/CEA_IMPROVEMENT_PLAN.md)
- **Floor Space**: 12,000 m² (120m x 100m)
- **Current Utilization**: 2.1% (4 turf nursery racks)
- **Purpose**: Turf production for 24 grass courts + health optimization produce
- **Implementation Status**: Concept phase - LED positioning and grass density fixes identified

### HVAC and Environmental Control
- **Documentation**: [hvac-specifications.md](../02-research/sports-facilities/hvac-specifications.md)
- **Temperature Ranges**:
  - Basketball/Volleyball: 65-70°F (40-60% RH)
  - Indoor Tennis: 55-62°F winter, 10-15°F below outdoor summer (55-60% RH)
  - Ice Rinks: 63°F air, 24-26°F ice surface (30% RH max)
  - Natatoriums: 80-84°F (50-60% RH)
- **Implementation Status**: Research complete

### Sports Facilities Research
- **Documentation**: [sports-facilities/](../02-research/sports-facilities/)
- **Research Areas**: HVAC, lighting, accessibility, spectator amenities, ice rink specs
- **Key Files**:
  - hvac-specifications.md - Temperature and humidity by sport type
  - lighting-specifications.md - Illuminance levels and glare control
  - accessibility-safety-standards.md - ADA compliance requirements
  - spectator-amenities.md - Seating, sightlines, acoustics
  - ice-hockey-rink-specifications.md - Ice maintenance systems
