    ...
    <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="mt-16 bg-white/5 border border-white/10 rounded-3xl p-8">
            <h3 className="text-2xl font-bold mb-6 flex items-center gap-3">
                <Server className="w-6 h-6 text-tennis-yellow" />
                ...
                <div>
                    ...
                    <ul className="space-y-2 text-gray-400">
                        <li className="flex items-start gap-2">
                            ...
                            <span>Biometric access control with NFC backup</span>
                        </li>
                        <li className="flex items-start gap-2">
                            <div className="w-1.5 h-1.5 rounded-full bg-tennis-yellow mt-1.5 flex-shrink-0" />
                            <span>32× 4K cameras with 30-day retention</span>
                        </li>
                        <li className="flex items-start gap-2">
                            <div className="w-1.5 h-1.5 rounded-full bg-tennis-yellow mt-1.5 flex-shrink-0" />
                            <span>Firewall with IDS/IPS, EDR on endpoints</span>
                        </li>
                        <li className="flex items-start gap-2">
                            <div className="w-1.5 h-1.5 rounded-full bg-tennis-yellow mt-1.5 flex-shrink-0" />
                            <span>ADA compliant throughout (IBC 2021)</span>
                        </li>
                    </ul>
                </div>
                <div>
                    <h4 className="font-bold text-white mb-3">Autonomous Systems</h4>
                    <ul className="space-y-2 text-gray-400">
                        <li className="flex items-start gap-2">
                            <div className="w-1.5 h-1.5 rounded-full bg-tennis-yellow mt-1.5 flex-shrink-0" />
                            <span>Multi-agent orchestration (scheduling, energy, safety)</span>
                        </li>
                        <li className="flex items-start gap-2">
                            <div className="w-1.5 h-1.5 rounded-full bg-tennis-yellow mt-1.5 flex-shrink-0" />
                            <span>Real-time sensor integration (1000+ devices)</span>
                        </li>
                        <li className="flex items-start gap-2">
                            <div className="w-1.5 h-1.5 rounded-full bg-tennis-yellow mt-1.5 flex-shrink-0" />
                            <span>Digital twin visualization (Unity/Three.js)</span>
                        </li>
                        <li className="flex items-start gap-2">
                            <div className="w-1.5 h-1.5 rounded-full bg-tennis-yellow mt-1.5 flex-shrink-0" />
                            <span>Hot/cold aisle containment for thermal efficiency</span>
                        </li>
                    </ul>
                </div>
            </div>
