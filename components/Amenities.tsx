      ...
      <div className="mb-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <motion.div
            ...
            transition={{ delay: 0 }}
            className="bg-white/5 border border-gray-500/20 hover:border-gray-500/40 rounded-3xl p-8 hover:bg-white/10 transition-all relative"
          >
            ...
            <button className="mt-8 w-full py-3 px-6 rounded-xl font-bold transition-all bg-white/5 border border-white/10 text-white hover:bg-white/10">
              Get Started
            </button>
          </motion.div>
          ...
          <motion.div
            ...
            className="bg-white/5 border border-tennis-yellow/20 hover:border-tennis-yellow/40 rounded-3xl p-8 hover:bg-white/10 transition-all relative"
          >
            ...
            <button className="mt-8 w-full py-3 px-6 rounded-xl font-bold transition-all bg-tennis-yellow text-slate-950 hover:bg-tennis-yellow/90">
              Get Started
            </button>
          </motion.div>
          ...
          <motion.div
            ...
            className="bg-white/5 border border-purple-500/20 hover:border-purple-500/40 rounded-3xl p-8 hover:bg-white/10 transition-all relative"
          >
            <div className="mb-6 pb-6 border-b border-white/10">
